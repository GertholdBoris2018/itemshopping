...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "/assets/NewTemplateAdmin/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "/assets/NewTemplateAdmin/assets/css/themes/" + selectedTheme + ".css");
