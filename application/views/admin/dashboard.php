            ...
            <header class="page-header">
                ...
                <div class="right-wrapper pull-right">
                    <ol class="breadcrumbs">
                        ...
                        <li><span><?php echo lang('side_dashboard');?></span></li>
                    </ol>
                                ...
                                <header class="panel-heading bg-primary">
                                    ...
                                    <div class="widget-profile-info">
                                        <div class="profile-picture">
                                            <img src="<?php echo ADMIN_IMAGE_PATH;?>!logged-user.jpg">
                                        </div>
                                        ...
                                        <li>
                                            <div class="tm-box">
                                                ...
                                                <div class="thumbnail-gallery">
                                                    <a class="img-thumbnail lightbox" href="<?php echo ADMIN_IMAGE_PATH;?>projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
                                                        <img class="img-responsive" width="215" src="<?php echo ADMIN_IMAGE_PATH;?>projects/project-4.jpg">
																<span class="zoom">
