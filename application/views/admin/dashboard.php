									...
									<div class="panel panel-white no-radius">
										...
										<div class="panel-body no-padding">
											<div class="padding-10">
												<img width="50" height="50" src="<?php echo ADMIN_NEW_IMAGE_PATH;?>avatar-1.jpg" class="img-circle pull-left" alt="">
													...
													<div id="users_followers" class="tab-pane padding-bottom-5 active">
														<div class="panel-scroll height-200">
															<table class="table no-margin">
																<tbody>
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="<?php echo ADMIN_NEW_IMAGE_PATH;?>avatar-1-small.jpg"></td>
																	...
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="<?php echo ADMIN_NEW_IMAGE_PATH;?>avatar-2-small.jpg"></td>
																	...
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="<?php echo ADMIN_NEW_IMAGE_PATH;?>avatar-3-small.jpg"></td>
																	...
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="<?php echo ADMIN_NEW_IMAGE_PATH;?>avatar-5-small.jpg"></td>
																	...
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="<?php echo ADMIN_NEW_IMAGE_PATH;?>avatar-4-small.jpg"></td>
												...
												<ol class="discussion">
													...
													<li class="self">
														<div class="message">
															...
															<div class="message-avatar">
																<img src="<?php echo ADMIN_NEW_IMAGE_PATH;?>avatar-1.jpg" alt="">
															</div>
														</div>
														<div class="message">
															<div class="message-name">
													...
													<li class="other">
														<div class="message">
															...
															<div class="message-avatar">
																<img src="<?php echo ADMIN_NEW_IMAGE_PATH;?>avatar-2.jpg" alt="">
															</div>
														</div>
													</li>
													<li class="self">
